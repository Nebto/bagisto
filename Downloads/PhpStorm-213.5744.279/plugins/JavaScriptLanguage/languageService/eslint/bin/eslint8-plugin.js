...
var ESLint8Plugin = /** @class */ (function () {
    function ESLint8Plugin(state) {
        ...
        var eslintPackagePath = eslint_common_1.normalizePath(state.eslintPackagePath);
        this.ESLint = eslint_common_1.requireInContext(eslintPackagePath + "lib/api", state.packageJsonPath).ESLint;
    }
                ...
                switch (_a.label) {
                    ...
                    case 7:
                        ...
                        response.isNoConfigFile = "no-config-found" === e_1.messageTemplate
                            || (e_1.message && eslint_common_1.containsString(e_1.message.toString(), "No ESLint configuration found"));
    ...
    ESLint8Plugin.prototype.invokeESLint = function (requestArguments, additionalOptions) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var parsedCommandLineOptions, options, eslint, config, plugins;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        parsedCommandLineOptions = {};
